...
<html lang="en">
  ...
  <!--<nav class="navbar navbar-dark bg-primary" style="background-color: #ddeeff;">   -->
              ...
              <!--  <a class="navbar-brand" href="#">Navbar</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item"> <a class="nav-link" href="{{ url('/odoo') }}">Purchase Odoo</a>  </li> 
                      <li class="nav-item"> <a class="nav-link" href="{{ url('/bisgateway') }}">BISMySQL</a>  </li> 
